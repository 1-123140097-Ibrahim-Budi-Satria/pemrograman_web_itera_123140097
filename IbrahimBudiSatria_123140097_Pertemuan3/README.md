...
```bash
cd IbrahimBudiSatria_123140097_Pertemuan3
```
...
*Tampilan halaman utama dengan form tambah buku dan daftar koleksi*

### Form Tambah/Edit Buku
![Form Buku](./screenshots/form.png)
*Form untuk menambahkan atau mengedit informasi buku*

### Filter dan Pencarian
![Filter](./screenshots/filter.png)
*Fitur filter berdasarkan status dan pencarian buku*

### Halaman Statistik
![Statistik](./screenshots/stats.png)
*Dashboard statistik dengan visualisasi data koleksi buku*

---

## 🛠️ Fitur React yang Diimplementasikan
